...
export const about = {
  ...
  education: {
    ...
    affiliation: "AICTE Approved • Govt. of West Bengal",
  ...
  timeline: [
    ...
    },
    {
      ...
      copy: "Enrolled at RKMGEC Purulia. Currently in 5th semester, 4 semesters completed and graded.",
    },
    {
      year: "Now",
...
export const projects: Project[] = [
  ...
  {
    id: "005",
    image: "/images/projects/private-chat.svg",
    title: "Private Android Chat App",
    description:
      "A custom-engineered native Android chatting and media sharing app built exclusively for me and my girlfriend — featuring end-to-end encrypted messaging, push notifications, voice notes, and a private shared memory gallery.",
    features: [
      "Exclusive 2-person paired authentication (strictly restricted to our two devices)",
      "Real-time instant messaging with Firebase Cloud Messaging (FCM) & WebSockets",
      "End-to-End Encryption (E2EE) ensuring complete privacy with zero third-party tracking",
      "Private photo & voice memo vault with biometric/PIN screen lock on launch",
    ],
    challenges:
      "Implementing reliable low-latency background push notifications on Android across power-saving modes while maintaining client-side payload encryption and private server synchronization.",
    stack: ["Android", "Kotlin / Java", "Firebase", "WebSockets", "Node.js", "Tailwind / XML"],
    categories: ["Mobile", "Personal", "Cybersecurity"],
    timeline: "2025 — 2026",
    live: null,
    github: null,
    featured: true,
...
export const navLinks = [
  ...
  { href: "/intel", label: "Threat Radar", live: true },
  { href: "/recon", label: "Target Recon" },
